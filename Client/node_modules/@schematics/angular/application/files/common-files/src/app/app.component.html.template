<<<<<<< HEAD:Client/src/app/app.component.html
<!-- header -->
<a [routerLink]="['/inicio']">Foro Genius Botsitos</a>
	<ul>
		...
		<li><a [routerLink]="['/users/edit/:id']">Editar Usuario</a></li>
		<li><a [routerLink]="['/forum/admin']">Administrar Foro</a></li>
	</ul>
...
<% if (routing) { %>
<router-outlet></router-outlet><% } %>
>>>>>>> 5ad27a36afd482cfab0b9aeeb170517074f26af1:Client/node_modules/@schematics/angular/application/files/common-files/src/app/app.component.html.template
